...
async function init() {
  ...
  try {
    ...
    if (nextBtn) nextBtn.innerHTML = `<svg viewBox="0 0 24 24" fill="#b3b3b3" width="20" height="20"><path d="M6 18l8.5-6L6 6v12zM16 6v12h2V6h-2z"/></svg>`;
...
// Start application safely checking document.readyState
